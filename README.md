...
`Excel` &nbsp;`Data Preparation` &nbsp; `Data Integration Process` &nbsp; `Data Analysis & Interpretation` &nbsp; `Tableau public` &nbsp; `Data Visualisation` &nbsp; `Statistical Insight & Critical Thinking` &nbsp; `Research & Domain Knowledge` &nbsp; 
